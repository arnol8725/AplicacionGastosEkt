...
@Component({
  ...
  templateUrl: '../views/dialog-data-egreso1225-dialog.html',
  providers: [    
    ProductoService,
  ],
})

export class DialogDataegreso1225Dialog {
...
public vermasme : boolean=false;
 ...
 public importe2: string;
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: any,private datosCuentasServicios: datosCuentasServicio,private _productoService2: ProductoService,private datosGeneralesServicios: datosGeneralesServicio,public dialog: MatDialog,) {
            ...
            this.titulo="Egreso de Gastos Neto";
                ...
                console.log(this.consulta);
                 console.log('Valor de consulta');
                   ...
                   if(this.consulta==false){
                       this.titulo="Error";
                       this.mensaje= "No se tiene una huella válida para realizar una validacion para el Egreso de Gasto Cuenta Neto";
                       this.pantalla=true;
                       this.cabecero=true;
 ...
 $('.mat-dialog-content').css({'overflow': 'hidden'});
  ...
  $('.mat-dialog-container').css({'width': '100%','height': '100%','max-width':'80vw'});
                                              ...
                                              console.log('Entro');
                                                ...
                                                $('.mat-dialog-container').css({'width': '100%','height': '100%','max-width':'80vw'});
                                                        this.titulo="Error";
                                                        this.mensaje='Error al obtener detalle de impresion del ticket ';
                                                        this.pantalla=true; 
                                                        this.PantallaImprimir=false;
                                                        this.boton=true;
                                                        this.retornar=false;
            ...
            $('.mat-dialog-container').css({'width': '25%','height': '150px','margin':'auto'});
              ...
              /*Metodos para realizar la impresion*/
               ...
               console.log(this.data.generales);
                       ...
                       this._productoService2.setArchivoImprimirEgresoCifra1225(this.datosGenerales,this.ticket,this.cajaDetalleFolios).subscribe(
                          result => {
                                 console.log('RESULTADO');
                                 console.log(result);
                                         ...
                                         this._productoService2.getIFolioImpresion(this.noImpresion).subscribe(
                                                  result => {
                                                                                  ...
                                                                                  //this.noImpresion=Number(this.impresion.Contenido);
                                                                                     ...
                                                                                     if (this.imagen.length>0){
                                                                                         ...
                                                                                         $('.mat-dialog-container').css({'width': '100%','height': '100%','max-width':'80vw'});
                                                                                           ...
                                                                                           $('.mat-dialog-container').css({'width': '100%','height': '100%','max-width':'80vw'});
                                                                                          this.titulo="Error";
                                                                                          this.mensaje='El ticket se imprimio correctamente, pero no se obtuvo correctamente el preview del ticket para su reimpresion';
                                                                                          this.pantalla=true; 
                                                                                          this.PantallaImprimir=false;
                                                                                          this.boton=true;
                                                                                          this.retornar=false;
                                                       ...
                                                       //   this.closeDialogCargar();
                                                           $('.mat-dialog-container').css({'width': '100%','height': '100%','max-width':'80vw'});
                                                                                          this.titulo="Error";
                                                                                          this.mensaje='Error al imprimir el ticket de impresion';
                                                                                          this.pantalla=true; 
                                                                                          this.PantallaImprimir=false;
                                                                                          this.boton=true;
                                                                                          this.retornar=false;
